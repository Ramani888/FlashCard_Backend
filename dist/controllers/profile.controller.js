...
const createSupport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (req.file) {
            ...
            yield (0, sendMail_1.default)('support@biblestudycards.app', 'SUPPORT', emailTemplate, imageUrl); //Roadtojesusministry@gmail.com
        }
        else {
            yield (0, profile_service_1.createSupportData)(Object.assign({}, bodyData));
            yield (0, sendMail_1.default)('support@biblestudycards.app', 'SUPPORT', emailTemplate); //Roadtojesusministry@gmail.com
        }
