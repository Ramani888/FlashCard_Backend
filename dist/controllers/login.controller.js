...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ userId: (_a = existingUser === null || existingUser === void 0 ? void 0 : existingUser._id) === null || _a === void 0 ? void 0 : _a.toString() }, SECRET_KEY, { expiresIn: '30d' } // expires in 5 minutes
        );
