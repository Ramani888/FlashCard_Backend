...
router.post(user_1.UserApiSource.post.addDefaultSetsAndCards.path, (0, bodyValidate_middleware_1.validateBody)(user_validate_1.addDefaultSetsAndCardsValidation, RouteSource === null || RouteSource === void 0 ? void 0 : RouteSource.Query), user_controller_1.addDefaultSetsAndCards);
