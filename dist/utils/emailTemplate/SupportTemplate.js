...
exports.getSupportTemplate = void 0;
    ...
    return `
        ...
        <table style="width: 600px; border-collapse: collapse; margin: auto; background: #ffffff;">
            ...
            <td style="background: #E9F9FF; border-radius: 24px; text-align: center;">
                <h1 style="font-size: 36px; color: #002634;">We have received your Support submission.</h1>
                <p style="font-size: 20px; color: #000;">We will contact you shortly. Thank you 🙌</p>
                <img src="https://flashcard-email-template-v1.s3.us-east-1.amazonaws.com/Iphone+Chat+1.png" width="480" height="344">
            </td>
            </tr>
            <tr>
            <td style="height: 32px; background: transparent;"></td>
...
exports.getSupportTemplate = getSupportTemplate;
