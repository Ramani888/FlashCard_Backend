...
export const createFolder = async (req: AuthorizedRequest, res: Response) => {
    ...
    try {
        ...
        res.status(StatusCodes.OK).send({ success: true, message: "Folder Created Successfully." });
    } catch (err) {
        console.error(err);
...
export const updateFolder = async (req: AuthorizedRequest, res: Response) => {
    ...
    try {
        ...
        res.status(StatusCodes.OK).send({ success: true, message: "Folder Updated Successfully." });
    } catch (err) {
        console.error(err);
        res.status(StatusCodes.INTERNAL_SERVER_ERROR).send({ error: err });
    }
...
export const deleteFolder = async (req: AuthorizedRequest, res: Response) => {
    ...
    try {
        ...
        res.status(StatusCodes.OK).send({ success: true, message: "Folder Deleted Successfully." });
    } catch (err) {
        console.error(err);
        res.status(StatusCodes.INTERNAL_SERVER_ERROR).send({ error: err });
    }
